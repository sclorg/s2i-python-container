...
This container image includes Python 3.14 as a [S2I](https://github.com/openshift/source-to-image) base image for your Python 3.14 applications.
...
Python 3.14 available as container is a base platform for
building and running various Python 3.14 applications and frameworks.
...
For this, we will assume that you are using one of the supported images available via imagestream tags in Openshift, eg. `python:3.14-ubi9`
Building a simple [python-sample-app](https://github.com/sclorg/django-ex.git) application
in Openshift can be achieved with the following step:

    ```
    oc new-app python:3.14-ubi9~https://github.com/sclorg/django-ex.git
    ```
...
```
podman pull quay.io/fedora/python-314
```
...
```
FROM quay.io/fedora/python-314
...
* **APP_MODULE**
    ...
    [setup-test-app](https://github.com/sclorg/s2i-python-container/tree/master/3.14/test/setup-test-app).
