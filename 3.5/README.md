...
The RHEL7 image is available in the [Red Hat Container Catalog](https://access.redhat.com/containers/#/registry.access.redhat.com/rhscl/python-35-rhel7)
as registry.access.redhat.com/rhscl/python-35-rhel7
and the RHEL8 image as [registry.access.redhat.com/rhel8/python-35](https://access.redhat.com/containers/#/registry.access.redhat.com/rhel8/python-35).
The CentOS7 image is then available on [Docker Hub](https://hub.docker.com/r/centos/python-35-centos7/)
...
*  **For RHEL8 based image**
    ```
    $ s2i build https://github.com/sclorg/s2i-python-container.git --context-dir=3.5/test/setup-test-app/ rhel8/python-35 python-sample-app
    $ docker run -p 8080:8080 python-sample-app
    ```
