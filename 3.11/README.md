...
For this, we will assume that you are using the supported image, available via `python:3.11` imagestream tag in Openshift.
Building a simple [python-sample-app](https://github.com/sclorg/django-ex.git) application
in Openshift can be achieved with the following step:

    ```
    oc new-app python:3.11~https://github.com/sclorg/django-ex.git
    ```
...
```
podman pull registry.fedoraproject.org/f37/python3
```
...
```
FROM registry.fedoraproject.org/f37/python3
