...
For this, we will assume that you are using one of the supported images available via imagestream tags in Openshift, eg. `python:3.8-ubi8`
Building a simple [python-sample-app](https://github.com/sclorg/django-ex.git) application
in Openshift can be achieved with the following step:

    ```
    oc new-app python:3.8-ubi8~https://github.com/sclorg/django-ex.git
    ```
